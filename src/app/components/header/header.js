class Header extends HTMLElement {
  ...
  <header class="fixed flex justify-between overflow-hidden h-16 top-0 left-0 right-0 w-max bg-black">
    ...
    <div class="ml-auto flex overflow-hidden items-center text-center mr-8">
      <a href="https://github.com/david-luison-starkey/bash-rest-dashboard" title="bash-rest-dashboard GitHub">
        <svg viewBox="0 0 16 16" class="w-8 h-8" fill="white" aria-hidden="true">
